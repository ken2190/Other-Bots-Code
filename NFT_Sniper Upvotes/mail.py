...
#In Short, this code generates emails on 1secmail.com
...
def start_process(username, domain):
    ...
    while True:
        ...
        if emails:
            ...
            if otp:
                #print(otp)
                link = (f'https://www.1secmail.com/mailbox/?action=readMessage&id={ID}&login={username}&domain={domain}')
                print(link)
                ...
                if inp.strip().lower() == 'f':
                    ...
                    #return(f'https://www.1secmail.com/mailbox/?action=readMessage&id={ID}&login={username}&domain={domain}')
                    break
